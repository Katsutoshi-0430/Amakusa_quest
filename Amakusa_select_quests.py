...
def save_user_data():
    ...
    data = {
        ...
        # 画像バイナリはBase64文字列に変換して保存
        "photo_data": {k: base64.b64encode(v).decode('utf-8') for k, v in st.session_state.photo_data.items()}
    }
